...
function addImportToNgModule(options) {
    return (host) => {
        ...
        const importChanges = ast_utils_1.addImportToModule(source, modulePath, 'ComponentRouterModule.forRoot()', '@angular-component/router').shift();
        const changes = [
            ast_utils_1.insertImport(source, modulePath, 'ComponentRouterModule', '@angular-component/router'),
            importChanges,
        ];
