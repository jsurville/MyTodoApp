(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('@angular-component/router', ['exports', '@angular/core', '@angular/common', 'rxjs', 'rxjs/operators'], factory) :
    (global = global || self, factory((global['angular-component'] = global['angular-component'] || {}, global['angular-component'].router = {}), global.ng.core, global.ng.common, global.rxjs, global.rxjs.operators));
    ...
    ***************************************************************************** */
    ...
    var Router = /** @class */ (function () {
        ...
        Router.prototype.parseSearchParams = function (params) {
        ...
        Router.prototype.stringifyQueryParams = function (params) {
    ...
    var filterNullable = function () { return function (source) {
        return source.pipe(operators.filter(isNotNullable));
    }; };
    ...
    var LinkActive = /** @class */ (function () {
        ...
        LinkActive.prototype.ngAfterContentInit = function () {
            ...
            this.links.changes
                ...
                .subscribe(function () { return _this.collectLinks(); });
            this.collectLinks();
        };
        ...
        LinkActive.prototype.collectLinks = function () {
            ...
            var contentLinks$ = this.links
                ? this.links
                    .toArray()
                    .map(function (link) {
                    return link.hrefUpdated.pipe(operators.startWith(link.linkHref), operators.mapTo(link.linkHref), filterNullable());
                })
                : [];
            var link$ = this.link
                ? this.link.hrefUpdated.pipe(operators.startWith(this.link.linkHref), operators.mapTo(this.link.linkHref), filterNullable())
                : rxjs.of('');
    ...
    var RouterComponent = /** @class */ (function () {
        ...
        RouterComponent.prototype.compareRoutes = function (previous, current) {
            ...
            return (previous.length === current.length &&
                previous.every(function (route, i) { return route === current[i]; }));
        };
    ...
    var ComponentRouterModule = /** @class */ (function () {
        function ComponentRouterModule() {
        }
        ComponentRouterModule_1 = ComponentRouterModule;
        ComponentRouterModule.forRoot = function () {
            return {
        ...
        ComponentRouterModule = ComponentRouterModule_1 = __decorate([
            core.NgModule({
        ...
        return ComponentRouterModule;
    }());

    exports.ComponentRouterModule = ComponentRouterModule;
...
//# sourceMappingURL=angular-component-router.umd.js.map
